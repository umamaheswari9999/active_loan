...
import '../../bloc/download_attachment/download_attachment_cubit.dart';
...
import '../../widget/loan_attachments_widget.dart';
import '../../widget/loan_steps/additional_details_step.dart';
import '../../widget/loan_steps/bank_details_step.dart';
import '../../widget/loan_steps/esign_emandate_step.dart';
import '../../widget/loan_steps/kyc_review_step.dart';
import '../../widget/loan_steps/kyc_step.dart';
import '../../widget/loan_steps/loan_details_step.dart';
import '../../widget/loan_steps/pre_approval_step.dart';
import '../../widget/utils/screen_utils.dart';
import 'new_loan_step_decider_screen.dart';
          ...
          if (preEnquiryForm.isDisbursed == false) ...[
              ...
              onPressed: () {
                showModalBottomSheet(context: context, builder: (ctx) {
                  return MultiBlocProvider(providers: [
                    BlocProvider(create: (ctx) => locator.get<LoanAttachmentsCubit>()..fetchLoanAttachments(preEnquiryForm.id)),
                    BlocProvider(create: (ctx) => locator.get<DownloadAttachmentCubit>()),
            ...
            IconButton(
              onPressed: () {
                showModalBottomSheet(context: context, builder: (ctx) {
                  return MultiBlocProvider(providers: [
                    BlocProvider(create: (ctx) => locator.get<AddAttachmentCubit>()),
                    BlocProvider(create: (ctx) => locator.get<AttachmentDocTypesCubit>()..fetchAttachmentDocTypes()),
            ...
            child: Stepper(
              ...
              steps: [
                Step(
                  ...
                  content: _currentStep == NewLoanStepDeciderScreen.kycStep ? const KycStepWidget() : emptyWidget,
                ),
                Step(
                  ...
                  content: _currentStep == NewLoanStepDeciderScreen.reviewKycStep ? const KycReviewStepWidget() : emptyWidget,
                ),
                Step(
                  title: const Text('Additional Information'),
                  state:
                      _getStepState(NewLoanStepDeciderScreen.additionalDetailsStep),
                  isActive:
                      _getIsActive(NewLoanStepDeciderScreen.additionalDetailsStep),
                  content: _currentStep == NewLoanStepDeciderScreen.additionalDetailsStep ? const AdditionalDetailsStep() : emptyWidget,
                ),
                Step(
                  title: const Text('Loan Details'),
                  state:
                      _getStepState(NewLoanStepDeciderScreen.loanRequirementsStep),
                  isActive:
                      _getIsActive(NewLoanStepDeciderScreen.loanRequirementsStep),
                  content: _currentStep == NewLoanStepDeciderScreen.loanRequirementsStep ? const LoanDetailsStep() : emptyWidget,
                ),
                Step(
                  ...
                  content: _currentStep == NewLoanStepDeciderScreen.bankDetailsStep ? const BankDetailsStepWidget() : emptyWidget,
                ),
                Step(
                  title: const Text('eSign & eMandate'),
                  state:
                      _getStepState(NewLoanStepDeciderScreen.eSignAndeMandateStep),
                  isActive:
                      _getIsActive(NewLoanStepDeciderScreen.eSignAndeMandateStep),
                  content: _currentStep == NewLoanStepDeciderScreen.eSignAndeMandateStep ? const ESignAndEMandateStepWidget() : emptyWidget,
                ),
                Step(
                  ...
                  content: _currentStep == NewLoanStepDeciderScreen.preApprovalStep ? const PreApprovalStepWidget() : emptyWidget,
                )
              ],
            ),
          ),
