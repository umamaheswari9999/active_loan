...
class DownloadAttachmentCubit extends Cubit<DownloadAttachmentState> {
  ...
  void fetchDownloadAttachment(String recordId, String fileName, String entityName) async {
    ...
    try {
      ...
      emit(
        DownloadAttachmentState.failure(
...
abstract class DownloadAttachmentState with _$DownloadAttachmentState {
  ...
  const factory DownloadAttachmentState.failure(Failure failure) = _DownloadAttachmentFailure;
}