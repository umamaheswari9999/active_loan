...
abstract class Constants {
  static const baseApiUrl = 'https://testsairoshni.nettlinx.com/erp';
  static const baseDefaultApiUrl = '$baseApiUrl/org.openbravo.service.json.jsonrest';
  static const baseCustomApiUrl = '$baseApiUrl/ws';
  static const smsCountry="http://api.smscountry.com/SMSCwebservice_bulk.aspx?mobilenumber=";
  static const bpFAQsUrl = "https://ezfinanz.com/business-partner-2";
  static const termsAndConditionsUrl = "https://ezfinanz.com/terms";
  static const defaultContactUs = "+917827001234";
  static const defaultContactUsEmail = "operations@ezfinanz.com";
...
abstract class LoanStage {
  ...
  static String mapStage(String stage) {
    switch (stage) {
      ...
      case waitingForKyc: return 'Waiting for KYC';
      case reviewKyc: return 'Review KYC';
      case additionalInfo: return 'Additional Info';
      case bankDetails: return 'Bank Details';
      case loanRequirements: return 'Loan Requirements';
      case initiateESign:
...
abstract class Entities {
  ...
  static const payCollection='lds_paycollection';
}
abstract class CustomWebServices {
  ...
  static const panvalidation="https://api.digio.in/v3/client/kyc/fetch_id_data/PAN";
   static const recentLoans = "com.saksham.loandetails.fetchAgentRecentLoans";
   static const clientMasterDetails = "com.saksham.loandetails.fetchclientMasterDetails";
...
static const sendEMandateLink = 'com.saksham.loandetails.eMandate';
  static const customerKyc ="com.saksham.loandetails.newCustomerKyc";
}
